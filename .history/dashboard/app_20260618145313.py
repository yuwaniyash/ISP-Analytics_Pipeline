...
# --- Row 1: KPI cards (left) + Pie chart (right) ---
...
# --- Row 2: Wide line chart ---
fig3 = px.line(usage_f, x="month_name", y="avg_usage_pct", color="plan_name",
               title="Usage Trends by Plan", markers=True,
               labels={"avg_usage_pct": "Avg Usage (%)", "month_name": "Month"})
fig3.update_layout(**DARK)
fig3.update_traces(line=dict(width=2.5))
st.plotly_chart(fig3, use_container_width=True)

# --- Row 3: Wide bar chart + small pie ---
